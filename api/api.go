...
func (api *Api) drawDefaultRoutes() {
	...
	api.privateRoutes.Get("/teams/services", api.route(servicesHandler, "GetUserServices"))
	...
	api.privateRoutes.Put("/teams/:team/services/:subdomain/plugins", api.route(servicesHandler, "ConfigurePlugin"))
